...
from tkcolorpicker_custom.functions import tk, ttk, round2, create_checkered_image, \
    overlay, PALETTE, hsv_to_rgb, hexa_to_rgb, rgb_to_hexa, col2hue, rgb_to_hsv
from tkcolorpicker_custom.alphabar import AlphaBar
from tkcolorpicker_custom.gradientbar import GradientBar
...
class ColorPicker(tk.Toplevel):
    ...
    def __init__(self, parent=None, color=(255, 0, 0), alpha=False,
                 title=_("Color Chooser"), yeelight_updater=None):
        """
...
#            self.alpha = tk.StringVar(self)
    ...
    def _update_preview(self):
        ...
        color = self.hexa.get()
        _yeelight_updater.set(hexa_to_rgb(color))
